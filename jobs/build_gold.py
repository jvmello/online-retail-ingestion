...
def main() -> None:
    ...
    assert_columns_exist(df_country_revenue, expected_country_revenue_columns, "gold.country_revenue")
    assert_no_nulls(df_country_revenue, ["Country", "TotalRevenue"], "gold.country_revenue")
    ...
    assert_columns_exist(df_monthly_revenue, expected_monthly_revenue_columns, "gold.monthly_revenue")
    assert_no_nulls(df_monthly_revenue, ["RevenueMonth", "TotalRevenue"], "gold.monthly_revenue")
